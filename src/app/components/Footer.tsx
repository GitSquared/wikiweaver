...
export default async function Footer() {
	...
	return (
		<footer className="w-screen bg-accent mt-12 border-t border-accent-foreground/10">
			<div className="max-w-[60rem] mx-auto p-8 grid gap-6 md:grid-cols-2 md:items-start">
				<div className="flex flex-col gap-6">
					<FooterParagraph>
						made by <FooterLink href="https://gaby.dev">gaby</FooterLink> in
						Paris for dreamers worldwide
					</FooterParagraph>
					<FooterParagraph>
						check out the code on{' '}
						<FooterLink href="https://github.com/GitSquared/wikiweaver">
							github
						</FooterLink>
					</FooterParagraph>
					<FooterParagraph>
